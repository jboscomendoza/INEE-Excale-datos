#Este documento contiene código para descargar, leer, guardar y manipular en R la base de datos correspondientes al Cuestionario de Contexto para Docentes del EXCALE 03 (Tercero de Primaria), aplicación 2010.

#1. Descarga
#Procedimiento 1: Descarga del archivo zip a una ubicación temporal, y asignación de la base de datos a la variable temp.
temp <- tempfile()
download.file("http://www.inee.edu.mx/images/stories/documentos_pdf/Bases_Datos/EXCALE03_2010/excale03_2010_doc_cuest.zip", temp)

#Procedimiento 2: Descarga del archivo zip y extracción de la base de datos al directorio de trabajo.
download.file("http://www.inee.edu.mx/images/stories/documentos_pdf/Bases_Datos/EXCALE03_2010/excale03_2010_doc_cuest.zip", "excale03_2010_doc_cuest.zip")
unzip("excale03_2010_doc_cuest.zip", "Excale03_2010_Doc_Cuest.TXT")
...
doc <- read.fwf(unz(temp, "Excale03_2010_Doc_Cuest.TXT"), widths = anchos, col.names = nombres)
#Si se ha descargado la base de datos al directorio de trabajo usar:
doc <- read.fwf("Excale03_2010_Doc_Cuest.TXT", widths = anchos, col.names = nombres)
...
doc <- read_fwf(unz(temp, "Excale03_2010_Doc_Cuest.TXT"), fwf_widths(anchos, nombres))
#Si se ha descargado la base de datos al directorio de trabajo usar:
doc <- read_fwf("Excale03_2010_Doc_Cuest.TXT", fwf_widths(anchos, nombres))
...
doc02 <- subset(doc, select = c(PP001:PP042))
doc03 <- subset(doc, select = c(WVARSTRR:W_FSTR100))

doc02[doc02 > 7] <- NA

doc <- cbind(doc01, doc02, doc03)
rm(doc01, doc02, doc03, anchos, nombres)

#III. Escritura
#Escritura de archivo csv que permite una lectura más sencilla de la base de datos.
#Procedimiento 1: Con librerías base
#Escritura
write.csv(doc, "excale03-2010-ex-doc.csv")
#Lectura a variable doc
doc <- read.csv("excale03-2010-ex-doc.csv")

#Procedimiento 2: Con readr
#Escritura
write_csv(doc, "excale03-2010-ex-doc.csv")
#Lectura a variable doc
doc <- read_csv("excale03-2010-ex-doc.csv")
