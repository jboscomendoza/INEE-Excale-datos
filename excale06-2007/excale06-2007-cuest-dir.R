...
dre <- read.fwf(unz(temp, "Excale06_2007_Directores.TXT"), widths = anchos, col.names = nombres)
#Si se ha descargado la base de datos al directorio de trabajo usar:
dre <- read.fwf("Excale06_2007_Directores.TXT", widths = anchos, col.names = nombres)
...
dre <- read_fwf(unz(temp, "Excale06_2007_Directores.TXT"), fwf_widths(anchos, nombres))
#Si se ha descargado la base de datos al directorio de trabajo usar:
dre <- read_fwf("Excale06_2007_Directores.TXT", fwf_widths(anchos, nombres))
