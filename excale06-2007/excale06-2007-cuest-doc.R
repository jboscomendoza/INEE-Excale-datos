...
doc <- read.fwf(unz(temp, "Excale06_2007_Docentes.txt"), widths = anchos, col.names = nombres)
#Si se ha descargado la base de datos al directorio de trabajo usar:
doc <- read.fwf("Excale06_2007_Docentes.txt", widths = anchos, col.names = nombres)
...
doc <- read_fwf(unz(temp, "Excale06_2007_Docentes.txt"), fwf_widths(anchos, nombres))
#Si se ha descargado la base de datos al directorio de trabajo usar:
doc <- read_fwf("Excale06_2007_Docentes.txt", fwf_widths(anchos, nombres))
