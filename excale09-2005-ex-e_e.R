#Este documento contiene código para descargar, leer, guardar y manipular en R la base de datos correspondiente a el EXCALE de Español (Expresión escrita) del EXCALE 09 (Tercero de Secundaria), aplicación 2005.

#1. Descarga
#Procedimiento 1: Descarga del archivo zip a una ubicación temporal, y asignación de la base de datos a la variable temp.
temp <- tempfile()
download.file("http://www.inee.edu.mx/images/stories/documentos_pdf/Bases_Datos/EXCALE2005_S3/excale09_2005_alum_expresion_escrita.zip", temp)

#Procedimiento 2: Descarga del archivo zip y extracción de la base de datos al directorio de trabajo.
download.file("http://www.inee.edu.mx/images/stories/documentos_pdf/Bases_Datos/EXCALE2005_S3/excale09_2005_alum_expresion_escrita.zip", "excale09_2005_alum_expresion_escrita.zip")
unzip("excale09_2005_alum_expresion_escrita.zip", files = "Excale09_2005_Alum_Expresion_Escrita.sav")
...
e_e <- read.spss(unzip(temp, "Excale09_2005_Alum_Expresion_Escrita.sav"), use.value.labels = FALSE, to.data.frame = TRUE)
#Si se ha descargado la base de datos al directorio de trabajo, usar:
e_e <- read.spss("Excale09_2005_Alum_Expresion_Escrita.sav", use.value.labels = FALSE, to.data.frame = TRUE)
...
e_e <- import(unzip(temp, "Excale09_2005_Alum_Expresion_Escrita.sav"))
#Si se ha descargado la base de datos al directorio de trabajo, usar:
e_e <- import("Excale09_2005_Alum_Expresion_Escrita.sav")
