#Este dirumento contiene código para descargar, leer, guardar y manipular en R la base de datos correspondiente al Cuestionario de Contexto del Director del EXCALE 06, aplicación 2013.
...
#2. Lectura de la base de datos y asignación a la variable dirc
...
dirc <- read.fwf(unz(temp, "Excale06_2013_Dir_Cuest.TXT"), widths = anchos, col.names = nombres)
#Si se ha descargado la base de datos al directorio de trabajo usar
dirc <- read.fwf("Excale06_2013_Dir_Cuest.TXT", widths = anchos, col.names = nombres)
...
dirc <- read_fwf(unz(temp, "Excale06_2013_Dir_Cuest.TXT"), fwf_widths(anchos, nombres))
#Si se ha descargado la base de datos al directorio de trabajo usar
dirc <- read_fwf("Excale06_2013_Dir_Cuest.TXT", widths = anchos, col.names = nombres)
...
#Lectura a variable dirc
dirc <- read.csv("excale06_2013_cuest_dir.csv")

#Procedimiento 2: Con readr
#Escritura
write_csv(dirc, "excale06_2013_cuest_dir.csv")
#Lectura a variable dirc
dirc <- read_csv("excale06_2013_cuest_dir.csv")
