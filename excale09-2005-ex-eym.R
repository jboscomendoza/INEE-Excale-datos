#Este documento contiene código para descargar, leer, guardar y manipular en R la base de datos correspondiente a los EXCALE de Español (Compresión lectora y Reflexión sobre la lengua) y Matemáticas del EXCALE 09 (Tercero de Secundaria), aplicación 2005.

#1. Descarga
#Procedimiento 1: Descarga del archivo zip a una ubicación temporal, y asignación de la base de datos a la variable temp.
temp <- tempfile()
download.file("http://www.inee.edu.mx/images/stories/documentos_pdf/Bases_Datos/EXCALE2005_S3/excale09_2005_alumnos.zip", temp)

#Procedimiento 2: Descarga del archivo zip y extracción de la base de datos al directorio de trabajo.
download.file("http://www.inee.edu.mx/images/stories/documentos_pdf/Bases_Datos/EXCALE2005_S3/excale09_2005_alumnos.zip", "excale09_2005_alumnos.zip")
unzip("excale09_2005_alumnos.zip", files = "Excale09_2005_Alumnos.sav")
...
eym <- read.spss(unzip(temp, "Excale09_2005_Alumnos.sav"), use.value.labels = FALSE, to.data.frame = TRUE)
#Si se ha descargado la base de datos al directorio de trabajo, usar:
eym <- read.spss("Excale09_2005_Alumnos.sav", use.value.labels = FALSE, to.data.frame = TRUE)
...
eym <- import(unzip(temp, "Excale09_2005_Alumnos.sav"))
#Si se ha descargado la base de datos al directorio de trabajo, usar:
eym <- import("Excale09_2005_Alumnos.sav")
