...
lyc <- read.fwf(unz(temp, "Excale00_2007_Alum_LC.TXT"), widths = anchos, col.names = nombres)
#Si se ha descargado la base de datos al directorio de trabajo usar:
lyc <- read.fwf("Excale00_2007_Alum_LC.TXT", widths = anchos, col.names = nombres)
...
lyc <- read_fwf(unz(temp, "Excale00_2007_Alum_LC.TXT"), fwf_widths(anchos, nombres))
#Si se ha descargado la base de datos al directorio de trabajo usar:
lyc <- read_fwf("Excale00_2007_Alum_LC.TXT", fwf_widths(anchos, nombres))
