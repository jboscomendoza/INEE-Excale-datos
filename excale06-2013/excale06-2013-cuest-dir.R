...
#5. Lectura de la base de datos y asignación a la variable dre.
...
dre[ , 8][dre[ , 8] == "999"] <- NA
dre[ , c(21, 22)][dre[ , c(21, 22)] == "9997" | dre[ , c(21, 22)] == "9999"] <- NA
dre[ , c(11:20, 25, 26)][dre[ , c(11:20, 25, 26)] >= 7] <- NA
dre[ , 23][dre[ , 23] >= 97] <- NA
dre[ , 24][dre[ , 24] >= 997] <- NA
...
#8. Lectura de la base de datos como csv y asignación a la variable dre.
