...
ayp <- read.fwf("Excale00_2007_Alum_Cuest.TXT", widths = anchos, col.names = c(nombres))
...
ayp <- read_fwf(unz(temp, "Excale00_2007_Alum_Cuest.TXT"), fwf_widths(anchos, c(nombres)))
#Si se ha descargado la base de datos al directorio de trabajo usar:
ayp <- read_fwf("Excale00_2007_Alum_Cuest.TXT", widths = anchos, col.names = c(nombres))
