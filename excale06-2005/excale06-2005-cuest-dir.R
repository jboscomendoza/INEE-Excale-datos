#Este documento contiene código para descargar, leer, guardar y manipular en R la base de datos correspondiente al Cuestionario de Contexto para Directores del EXCALE 06 (Sexto de Primaria), aplicación 2005.

#1. Descarga
#Procedimiento 1: Descarga del archivo zip a una ubicación temporal, y asignación de la base de datos a la variable temp.
temp <- tempfile()
download.file("http://www.inee.edu.mx/images/stories/documentos_pdf/Bases_Datos/EXCALE2005_P6/excale06_2005_directores.zip", temp)

#Procedimiento 2: Descarga del archivo zip y extracción de la base de datos al directorio de trabajo.
download.file("http://www.inee.edu.mx/images/stories/documentos_pdf/Bases_Datos/EXCALE2005_P6/excale06_2005_directores.zip", "excale06_2005_directores.zip")
unzip("excale06_2005_directores.zip", files = "Excale06_2005_Directores.sav")
...
dre <- read.spss(unzip(temp, "Excale06_2005_Directores.sav"), use.value.labels = FALSE, to.data.frame = TRUE)
#Si se ha descargado la base de datos al directorio de trabajo, usar:
dre <- read.spss("Excale06_2005_Directores.sav", use.value.labels = FALSE, to.data.frame = TRUE)
...
dre <- import(unzip(temp, "Excale06_2005_Directores.sav"))
#Si se ha descargado la base de datos al directorio de trabajo, usar:
dre <- import("Excale06_2005_Directores.sav")
