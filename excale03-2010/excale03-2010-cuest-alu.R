#Este documento contiene código para descargar, leer, guardar y manipular en R la base de datos correspondientes al Cuestionario de Contexto para Alumnos del EXCALE 03 (Tercero de Primaria), aplicación 2010.

#1. Descarga
#Procedimiento 1: Descarga del archivo zip a una ubicación temporal, y asignación de la base de datos a la variable temp.
temp <- tempfile()
download.file("http://www.inee.edu.mx/images/stories/documentos_pdf/Bases_Datos/EXCALE03_2010/excale03_2010_alum_cuest.zip", temp)

#Procedimiento 2: Descarga del archivo zip y extracción de la base de datos al directorio de trabajo.
download.file("http://www.inee.edu.mx/images/stories/documentos_pdf/Bases_Datos/EXCALE03_2010/excale03_2010_alum_cuest.zip", "excale03_2010_alum_cuest.zip")
unzip("excale03_2010_alum_cuest.zip", "Excale03_2010_Alum_Cuest.TXT")
...
alu <- read.fwf(unz(temp, "Excale03_2010_Alum_Cuest.TXT"), widths = anchos, col.names = nombres)
#Si se ha descargado la base de datos al directorio de trabajo usar:
alu <- read.fwf("Excale03_2010_Alum_Cuest.TXT", widths = anchos, col.names = nombres)
...
alu <- read_fwf(unz(temp, "Excale03_2010_Alum_Cuest.TXT"), fwf_widths(anchos, nombres))
#Si se ha descargado la base de datos al directorio de trabajo usar:
alu <- read_fwf("Excale03_2010_Alum_Cuest.TXT", fwf_widths(anchos, nombres))
...
#Escritura
write.csv(alu, "excale03-2010-ex-alu.csv")
#Lectura a variable alu
alu <- read.csv("excale03-2010-ex-alu.csv")

#Procedimiento 2: Con readr
#Escritura
write_csv(alu, "excale03-2010-ex-alu.csv")
#Lectura a variable alu
alu <- read_csv("excale03-2010-ex-alu.csv")
